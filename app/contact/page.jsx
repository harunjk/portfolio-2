...
const info=[
    {
        icon:<FaPhoneAlt/>,
        title:"Phone",
        description:"(+880) 1312 693045"
    },
    {
        icon:<FaEnvelope/>,
        title:"Email",
        description:"harun.wb@gmail.com"
    },
    {
        icon:<FaMapMarkedAlt/>,
        title:"Address",
        description:"Mohadevpur, Naogaon"
    },
]
                ...
                <div className='flex flex-col xl:flex-row gap-[30px]'>
                    <div className='xl:w-[54%] order-2 xl:order-none'>
                        <form className='flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl'>
                            ...
                            <p className='text-white/60'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ratione totam eos, veritatis quis sint repellendus.</p>
                            ...
                            <Select>
                                ...
                                <SelectContent>
                                    <SelectGroup>
                                        <SelectLabel>Select a Item</SelectLabel>
